...
const Hero = () => {
  ...
  return (
    <div className=" text-center text-black-800 py-24 px-6">
      <h1
        className="text-5xl md:text-6xl xl:text-7xl font-bold
      tracking-tight mb-12"
      >
        <span className="capitalize">"Together We Give: Join Our Generosity-Driven Crowdfunding Movement"</span>
        <br />
        <span className=" text-blue-600">GenerosityGuru</span>
      </h1>
      <div className="flex justify-center items-center space-x-2">
        <button
          type="button"
          className="inline-block px-6 py-2.5 border border-black bg-blue-600 
      ...
      <div className="flex justify-center items-center mt-10">
        <div
          ...
          h-20 border border-black shadow-md w-full"
        >
          <span
